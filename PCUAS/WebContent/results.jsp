...
<body>
	...
	<div id="main-container">
		<br>
		<br> <label class="main-title2">Results</label>
		<ul class="grid">
			...
			<li>
				<figure>
					<div class="caption-hover-effect">
						...
						<div class="caption">
							<h3>Results</h3>
							<p>First Choice Accepted-BS Computer Science</p>
						</div>
					</div>
				</figure>
			</li>
			<li>
				<div class="caption-hover-effect">
					...
					<div class="caption">
						<h3>Results</h3>
						<p>First Choice Wait Listed-BS Business Administration</p>
					</div>
				</div>
			</li>
			<li>
				<div class="caption-hover-effect">
					...
					<div class="caption">
						<h3>Results</h3>
						<p>Pending (Results Will Be Released on 09/27/2015)</p>
					</div>
				</div>
			</li>
		</ul>
